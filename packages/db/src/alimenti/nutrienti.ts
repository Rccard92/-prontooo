...
const RIGHE: Riga[] = [
  ...
  // Le voci aggiunte dopo ottocento letture del catalogo. Valori CREA, come
  // gli altri: indicativi, servono a stimare una giornata.
  ['Costine di maiale', 280, 17, 0, 24, 0, 'macelleria'],
  ['Macinato di maiale', 218, 18, 0, 16, 0, 'macelleria'],
  ['Filetto di maiale', 159, 21, 0, 8, 0, 'macelleria'],
  ['Cotechino', 307, 17, 0, 27, 0, 'macelleria'],
  ['Cinghiale', 107, 21, 0, 2.4, 0, 'macelleria'],
  ['Pesce persico', 91, 19, 0, 1, 0, 'pescheria'],
  ['Rana pescatrice', 73, 15, 0.5, 1, 0, 'pescheria'],
  ['Triglie', 123, 17, 0, 6, 0, 'pescheria'],
  ['Gallinella', 82, 17, 0, 1.5, 0, 'pescheria'],
  ['Moscardini', 78, 14, 1.5, 1.5, 0, 'pescheria'],
  ['Scampi', 85, 17, 1, 1, 0, 'pescheria'],
  ['Polpa di granchio', 87, 18, 0, 1, 0, 'pescheria'],
  ['Robiola', 330, 19, 1.5, 28, 0, 'frigo'],
  ['Ricotta salata', 280, 24, 2, 20, 0, 'frigo'],
  ['Ricotta di pecora', 157, 9.5, 4, 11, 0, 'frigo'],
  ['Emmental', 403, 28, 1.5, 31, 0, 'frigo'],
  ['Groviera', 389, 29, 0.5, 30, 0, 'frigo'],
  ['Formaggio a fette', 300, 18, 6, 23, 0, 'frigo'],
  ['Farina di mais', 362, 8.7, 78, 2.7, 3, 'dispensa'],
  ['Farina di riso', 366, 6, 80, 1.4, 2.4, 'dispensa'],
  ['Farina di castagne', 371, 6, 76, 3.7, 8.5, 'dispensa'],
  ['Farina di farro', 340, 15, 67, 2.5, 6.8, 'dispensa'],
  ['Farina di ceci', 387, 22, 58, 6.7, 11, 'dispensa'],
  ['Farina di mandorle', 600, 21, 10, 53, 12, 'dispensa'],
  ['Amido di mais', 381, 0.3, 94, 0.1, 0.9, 'dispensa'],
  ['Panko', 370, 12, 72, 3, 4, 'dispensa'],
  ['Pasta fillo', 299, 8, 58, 3, 2, 'frigo'],
  ['Pasta brisee', 430, 6, 40, 27, 1.5, 'frigo'],
  ['Ravioli', 280, 11, 40, 8, 2, 'frigo'],
  ['Fregola', 356, 12, 72, 1.5, 3, 'dispensa'],
  ['Noodles di riso', 364, 6, 83, 0.6, 1.6, 'dispensa'],
  ['Seitan', 121, 24, 4, 1, 0.6, 'frigo'],
  ['Olio di semi di arachide', 899, 0, 0, 100, 0, 'dispensa'],
  ['Strutto', 891, 0, 0, 99, 0, 'dispensa'],
  ['Salsa Worcestershire', 78, 0, 19, 0, 0, 'dispensa'],
  ['Salsa teriyaki', 89, 5, 16, 0, 0, 'dispensa'],
  ['Miso', 199, 12, 26, 6, 5, 'dispensa'],
  ['Semi di papavero', 525, 18, 28, 42, 20, 'dispensa'],
  ['Fiori di zucca', 20, 3, 1, 0.2, 1, 'ortofrutta'],
  ['Topinambur', 73, 2.3, 17, 0.1, 1.6, 'ortofrutta'],
]
